    ...
    protected void parse(BufferedReader reader) throws LifecycleException {
        ...
        while (true) {
            try {
                ...
                if (result instanceof RewriteRule) {
                ...
                } else if (result instanceof Object[] && ((Object[]) result)[1] instanceof RewriteMap) {
                    ...
                    headers.put(((String[])result)[0], ((String[])result)[1]);
                }
            } catch (IOException e) {
    ...
    public static Object parse(String line) {
        ...
        if (tokenizer.hasMoreTokens()) {
            ...
            if (token.equals("RewriteCond")) {
                ...
                if ("set".equals(tokenizer.nextToken())) {
                    String name = tokenizer.nextToken();
                    ...
                    return new String[] {name,  sb.toString().replaceAll("\"", "")};
                } else {
                    throw new IllegalArgumentException("Invalid line: " + line);
                }
